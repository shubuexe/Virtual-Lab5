...
function setupSplashScreen() {
  // Initialize circuit background lines
  initCircuitLines();
  ...
  }, 3500); // Total time to show splash screen
}

// Simple opening animation
function setupIntroAnimation() {
  // Animation has been completely disabled
  // Do nothing - animation removed as requested
  return;
}
